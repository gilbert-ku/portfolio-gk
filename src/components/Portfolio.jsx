                    ...
                    <div className="cards">
                        <img src="/images/Screenshot from 2023-09-15 13-32-57.png" alt="School Home Page" width="600px"/>
                            <div className="card-description">
                                <h1><a href="https://github.com/gilbert-ku/phase-1-one--school_project-">School Website</a></h1>
                       ...
                       <div className="cards">
                            ...
                            <div className="card-description">
                                <h1> <a href="https://github.com/gilbert-ku/Go-Trave">Go Travel</a></h1>
                        ...
                        <img src="/images/Screenshot from 2023-09-15 13-39-03.png" alt="school database" width="600px"/>
                            <div className="card-description">
                                <h1><a href="https://github.com/gilbert-ku/schooldb-cli-project"> School Management CLI App with Python and SQLAlchemy</a></h1>
